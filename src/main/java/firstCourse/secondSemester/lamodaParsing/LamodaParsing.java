package firstCourse.secondSemester.lamodaParsing;
...
public class LamodaParsing {
    private final static int FOR_BRAND = 1;
    private final static int FOR_TYPE = 3;

    private final static String PATH_FOR_HTML = "src/main/resources/firstCourse/secondSemester/lamodaParsing/Lamoda.html";
